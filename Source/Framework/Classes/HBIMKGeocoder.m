...
#import "HBIMKGeocoder.h"
#import "JSON.h"
#import "HBIMKPlacemark+Private.h"

@interface HBIMKGeocoder (WebViewIntegration)
...
@interface HBIMKGeocoder (Private)
...
- (void)webView:(WebView *)sender didClearWindowObject:(WebScriptObject *)windowScriptObject forFrame:(WebFrame *)frame
{
    ...
    [windowScriptObject setValue:self forKey:@"HBIMKGeocoder"];
}
...
{
    //NSLog(@"didFinishLoad:");
    [[webView windowScriptObject] setValue:self forKey:@"HBIMKGeocoder"];
    webViewLoaded = YES;
...
- (void)createWebView
{
    ...
    NSBundle *frameworkBundle = [NSBundle bundleForClass:[HBIMKGeocoder class]];
