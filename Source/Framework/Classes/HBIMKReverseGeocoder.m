...
@interface HBIMKReverseGeocoder (Private)
...
@implementation HBIMKReverseGeocoder
...
- (void)webView:(WebView *)sender didClearWindowObject:(WebScriptObject *)windowScriptObject forFrame:(WebFrame *)frame
{
    ...
    [windowScriptObject setValue:self forKey:@"HBIMKReverseGeocoder"];
}
...
{
    //NSLog(@"didFinishLoad:");
    [[webView windowScriptObject] setValue:self forKey:@"HBIMKReverseGeocoder"];
    webViewLoaded = YES;
...
- (void)createWebView
{
    ...
    NSBundle *frameworkBundle = [NSBundle bundleForClass:[HBIMKReverseGeocoder class]];
